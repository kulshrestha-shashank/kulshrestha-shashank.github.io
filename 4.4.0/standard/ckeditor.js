...
(function () {
    ...
    (function () {
        ...
        function c(a, d, f, e) {
            ...
            if (!e) return 0;
            if ((h = CKEDITOR.filter.instances[e.element.data("cke-filter")]) && !h.check(d)) return c(a, d, f, e.remaining); d = new CKEDITOR.dom.range(e.element); d.selectNodeContents(e.element); d = d.createIterator(); d.enlargeBr = a.enlargeBr; d.enforceRealBlocks = a.enforceRealBlocks; d.activeFilter = d.filter = h; a._.nestedEditable = {
                element: e.element,
                container: f,
    ...
    (function () {
        ...
        function u(a, b, d, g) {
            ...
            if (g.doFilter) {
                a: {
                    m = b.name;
                    l = a._; a = l.allowedRules.elements[m]; j = l.allowedRules.generic; m = l.disallowedRules.elements[m]; l = l.disallowedRules.generic; h = g.skipRequired; r = {
                        valid: false,
                        validAttributes: {},
                        validClasses: {},
                        validStyles: {},
                ...
                t = a.validAttributes;
                var i = a.validStyles; j = a.validClasses;
                var m = b.attributes,
                    k = b.styles,
                    l = b.classes,
                    h = b.classBackup,
                    B = b.styleBackup,
                    y, x, N = []; r = [];
                var n = /^data-cke-/; w = false; delete m.style; delete m["class"]; delete b.classBackup; delete b.styleBackup;
                if (!a.allAttributes)
                    for (y in m)
                        if (!t[y])
                            if (n.test(y)) {
                ...
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        a: {
                            ...
                            d = CKEDITOR.htmlParser.fragment.fromHtml(d); d.children.length == 1 && (l = d.children[0]).type == CKEDITOR.NODE_ELEMENT && u(g, l, c, p); c = !c.length
                        }
                        c || f.push(a)
                    }
                }, null, true);
                        ...
                        for (j(y, D) ; x < y.length; x++) {
                            ...
                            if (u) q = x > 0;
                                ...
                                if (T) {
                                    ...
                                    T = 0
                                } else D.insertNode(B.node);
                                if (B.lastNotAllowed && x < y.length - 1) {
